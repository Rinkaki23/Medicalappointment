...
<?php include ('nav.php'); ?>
   ...
   <div class="row" style="margin-right:-15px;margin-left:-15px;" >
        <div class="col-md-12" style="padding-right:40px;padding-left:40px;">
            <section id="content">
            <a href="appointments.php" class="btn btn-primary btn-sm  waves-effect"> <i class="glyphicon glyphicon-plus"></i> Set Appointment</a><br><br>
            <table class="table table-bordered table-hover">
                                ...
                                $result = mysqli_query($mysqli,"select * from appointment where cancel='N/A' ORDER BY `appointment`.`date_sent` DESC") or die(mysqli_error());
                                ...
                                <tbody>
                                    ...
                                    </center></td><?php include 'modals/delete_modal.php'; ?>
                                    </tr>  
                                   <?php endwhile; ?>
