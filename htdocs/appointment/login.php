...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <div class="col-sm-6" style="background-color:rgb(242,242,242); height:100%"> 
  <div class="row">
    <div class="col-sm-offset-2 col-sm-8" style="margin-top:100px"> 
      <form action="../checklogin.php" method="post">
      	<label>Username</label>
  <div class="input-group">
    <span class="input-group-addon"><img src="../icons/patient.png" style="max-height:20px;"/></span>
    <input id="text" type="text" class="form-control" name="username" placeholder="Email">
  </div><br><br>
      	<label>Password</label>
  <div class="input-group">
    <span class="input-group-addon"><img src="../icons/Register-icon.png" style="max-height:20px;"/></span>
    <input id="password" type="password" class="form-control" name="password" placeholder="Password">
  </div><br><br>
  <div class="input-group">
    <input id="password" type="submit" class="btn btn-success" name="password" value="Login" style="display:block;width:100%">
  </div>
</form>
</div>
    </div>
